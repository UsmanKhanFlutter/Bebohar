...
const String base_url = 'https://bebohar.com/webservice';
  ...
  Future<Map<String, dynamic>> checkCoupon(
    ...
    try {
      ...
      if (body['message'].toString() == 'Coupon code not valid.') {
        return {};
      } else if (body['message'].toString() == 'General error.') {
        return {};
      }
      return {
      ...
      final categoriesList = data
          .map((json) => Category(
                ...
                image: json['image'] != null &&
                    ...
                    ? 'https://bebohar.com/webservice/assets/category/${json['image']}'
                    : '',
              ))
          .toList();
  ...
  Future<void> getSubCategories(String catId) async {
    ...
    try {
      await http.post(
        ...
        responseData = json.decode(value.body) as Map<String, dynamic>;
      });
      //final responseData = json.decode(response.body) as Map<String, dynamic>;
      if (responseData['message'] != 'Get all Categories') {
        return null;
